...
class Claim extends FactionCommand
{
    ...
    public function onNormalRun(Player $sender, Session $session, ?string $faction, array $args): void
    {
        if (!is_null(Cache::$factions[$faction]["claim"])) {
            $sender->sendMessage(Util::PREFIX . "Vous avez déjà un claim. Faites §n/f unclaim§f pour le supprimer");
            return;
        ...
        Cache::$factions[$faction]["logs"][time()] = "§n" . $sender->getName() . " §fa récupéré un nouveau claim";
