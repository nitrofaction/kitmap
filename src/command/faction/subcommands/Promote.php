...
class Promote extends FactionCommand
{
    ...
    public function onNormalRun(Player $sender, Session $session, ?string $faction, array $args): void
    {
        ...
        Cache::$factions[$faction]["logs"][time()] = "§n" . $sender->getName() . " §fpromote §n" . $args["membre"] . "§f" . $rank_name;
        Faction::broadcastFactionMessage($faction, "Le joueur §n" . $args["membre"] . " §fvient d'être promu §n" . $rank_name);
    }
