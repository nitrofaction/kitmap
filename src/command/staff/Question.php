    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        switch (mt_rand(1, 3)) {
            case 1:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le premier à réécrire le code pour gagner §q5k$ §f! Code: §q" . $code);
            ...
            case 2:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le premier à trouver le bon mot pour gagner §q5k$ §f! Mot: §q" . str_shuffle($word));
            ...
            case 3:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le premier à répondre au calcul pour gagner §q5k$ §f! Calcul: §q" . $number1 . " " . $method . " " . $number2);
