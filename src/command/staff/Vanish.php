    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        if ($sender instanceof Player) {
            ...
            if (in_array($sender->getName(), Vanish::$vanish)) {
                ...
                if ($item->getCustomName() === "§r" . Util::PREFIX . "Vanish" . Util::IARROW) {
                    $sender->getInventory()->setItemInHand(VanillaItems::DYE()->setColor(DyeColor::LIGHT_GRAY())->setCustomName("§r" . Util::PREFIX . "Vanish" . Util::IARROW));
                }
            } else {
                foreach (Main::getInstance()->getServer()->getOnlinePlayers() as $player) {
                ...
                if ($item->getCustomName() === "§r" . Util::PREFIX . "Vanish" . Util::IARROW) {
                    $sender->getInventory()->setItemInHand(VanillaItems::DYE()->setColor(DyeColor::GREEN())->setCustomName("§r" . Util::PREFIX . "Vanish" . Util::IARROW));
                }
            }
        }
    }
