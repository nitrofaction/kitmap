...
class ResetJobs extends BaseCommand
{
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        $sender->sendMessage(Util::PREFIX . "Vous venez de reset les métiers de §n" . $player->getName());
        $player->sendMessage(Util::PREFIX . "Vos métiers ont été resets par le staff §n" . $sender->getName());
    }
