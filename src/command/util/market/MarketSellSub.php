    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        if ($sender instanceof Player) {
            ...
            $item->setLore(array_merge($item->getLore(), [
                "§r§f ",
                "§r§fVendeur: §n" . $sender->getName(),
                "§r§fPrix: §n" . $args["prix"] . "$",
                "§r§n ",
                "§r§nCliquez ici pour acheter",
            ]));
            ...
            $sender->sendMessage(Util::PREFIX . "Vous venez de vendre l'item dans votre main au prix de §n" . $args["prix"]);
        }
    }
